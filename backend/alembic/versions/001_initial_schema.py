...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("cloudwm_api_url", sa.String(255), nullable=True),
        sa.Column("cloudwm_client_id", sa.String(255), nullable=True),
        sa.Column("cloudwm_secret_encrypted", sa.Text, nullable=True),
        ...
        sa.Column("gateway_lan_ip", sa.String(45), nullable=True),
        sa.Column("default_network_name", sa.String(100), nullable=True),
